 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
          ...
          addLabel() {
            ...
            L ? e3.shortenLabel = function() {
              for (M = 0; M < L.length; M++)
                if (h(T, { dateTimeLabelFormat: L[M] }), S.attr({ text: A.call(T, T) }), S.getBBox().width < i3.getSlotWidth(e3) - 2 * (f.padding || 0))
                  return;
              S.attr({ text: "" });
              ...
              e3.hasVisibleSeries = false, e3.dataMin = e3.dataMax = e3.threshold = void 0, e3.softThreshold = !e3.isXAxis, e3.series.forEach((i3) => {
                if (i3.reserveSpace()) {
                  ...
                  if (e3.hasVisibleSeries = true, e3.positiveValuesOnly && 0 >= (o2 || 0) && (o2 = void 0), e3.isXAxis)
                    (r2 = i3.xData) && r2.length && (r2 = e3.logarithmic ? r2.filter((t4) => t4 > 0) : r2, n2 = (t3 = i3.getXExtremes(r2)).min, a2 = t3.max, A(n2) || n2 instanceof Date || (r2 = r2.filter(A), n2 = (t3 = i3.getXExtremes(r2)).min, a2 = t3.max), r2.length && (e3.dataMin = Math.min(E(e3.dataMin, n2), n2), e3.dataMax = Math.max(E(e3.dataMax, a2), a2)));
                  else {
        ...
        class p {
          ...
          render() {
            ...
            if (!t3.chart.styledMode && (M ? (T.stroke = r2 || "#999999", T["stroke-width"] = c(e3.width, 1), e3.dashStyle && (T.dashstyle = e3.dashStyle)) : k && (T.fill = r2 || "#e6e9ff", x && (T.stroke = e3.borderColor, T["stroke-width"] = x))), p2.zIndex = a2, A += "-" + a2, (C = t3.plotLinesAndBandsGroups[A]) || (t3.plotLinesAndBandsGroups[A] = C = u.g("plot-" + A).attr(p2).add()), v || (this.svgElem = v = u.path().attr(T).add(C)), o(m))
        ...
        class A {
          ...
          refresh(t3, e3) {
            ...
            if (this.distance = k(T2.tooltipOptions.distance, 16), false === M2)
              this.hide();
            else {
              if (this.split && this.allowShared)
                this.renderSplit(M2, a2);
              else {
                let t4 = v2, o2 = C2;
        ...
        class X {
          ...
          setData(t3, e3 = true, i3, s2) {
            ...
            if (l2 && l2.enabled && (t3 = this.sortData(t3)), h2.options.chart.allowMutatingData && false !== s2 && k2 && n2 && !r2.cropped && !r2.hasGroupedData && r2.visible && !r2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              ...
              for (u2 && B(u2[0]) && T(14, true, h2), r2.data = [], r2.options.data = r2.userOptions.data = t3, x2 = n2; x2--; )
          ...
          generatePoints() {
            ...
            for (h2 && a2 && (this.options.keys = false), g2 = 0; g2 < o2; g2++)
              p2 = n2 + g2, a2 ? ((u2 = new r2(this, [i3[g2]].concat(G(s2[g2])))).dataGroup = this.groupMap[d2 + g2], u2.dataGroup.options && (u2.options = u2.dataGroup.options, A(u2, u2.dataGroup.options), delete u2.dataLabels)) : (u2 = f2[p2]) || void 0 === e3[p2] || (f2[p2] = u2 = new r2(this, e3[p2], i3[g2])), u2 && (u2.index = a2 ? d2 + g2 : p2, l2[g2] = u2);
        ...
        class Q {
          ...
          propFromSeries() {
            ...
            ["inverted", "angular", "polar"].forEach(function(n2) {
              for (e3 = T[r2.type], i3 = r2[n2] || e3 && e3.prototype[n2], t3 = o2 && o2.length; !i3 && t3--; )
                (e3 = T[o2[t3].type]) && e3.prototype[n2] && (i3 = true);
              s2[n2] = i3;
            });
          }
          linkSeries(t3) {
            ...
            t3.visible && ((_a = t3.hasDataLabels) == null ? void 0 : _a.call(t3)) && (e4.forEach((t4) => {
              ...
              l2 && (t3.sortByAngle(e5, n3 - 0.5), C > 0 && (f2 = Math.max(0, g2 - c2 - C), m3 = Math.min(g2 + c2 + C, i4.plotHeight), e5.forEach((t4) => {
                ...
                (i5.dataLabels || []).forEach((h2) => {
                  ...
                  if (f3) {
                    if (d2 && p(g3) && f3.distance > 0 && (void 0 === g3.pos ? T = "hidden" : (S = g3.size, w = y.radialDistributionY(i5, h2))), l3.justify)
