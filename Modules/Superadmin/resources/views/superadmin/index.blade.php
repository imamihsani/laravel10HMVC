                ...
                <div class="table-responsive">
                    <table class="table table-sm nowrap table-bordered table-striped" style="width:100%" id="datatable">
                        <thead class="bg-primary">
                            <tr>
                                <th class="bg-primary" style="width:25px;">No.</th>
                                <th class="bg-primary" style="width:125px;">Nama Role</th>
                                <th class="bg-primary">Permission</th>
                                <th class="text-center bg-primary" style="width:55px;">
                                    Action
                                </th>
                            </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <td class="font-weight-bold">{{ $role->nama_role }}</td>
                            <td>
                            ...
                            <td class="text-center">
                                <!-- <div class="btn-group" role="group" aria-label="Basic example"> -->
                                    ...
                                    <a type="button" target="_usergroup" href="{{url('superadmin/superadmin/role'). '?id=' . $role->id}}" class="btn btn-warning btn-sm btn-block"><i class="fa fa-edit"></i></a>
                                <!-- </div> -->
                            </td>
                        </tr>
                        @endforeach
